...
void init()
{
	shader = new GLShader("shader/particlesystemtransback.vert","shader/particlesystemtransback.frag");
	...
	char dir[256];
	sprintf(dir,"%s%s",RelativeDir,"data/blueWater.png");
...
//	printf("Written: %d\n", ptsWritten);
	...
	mat4 projection_matrix = glm::perspective(60.0f,1.0f,1.0f,1000.0f);
	mat4 view_matrix = glm::lookAt(vec3(0.0,0.0,4.0),vec3(0.0),vec3(0.0,1.0,0.0));
